        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center hover:opacity-80 transition" aria-label="BookShare - Go to home page">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="px-4 pb-2 border-b border-gray-200">
                <a href="{{ route('home') }}" class="flex items-center hover:opacity-80 transition" aria-label="BookShare - Go to home page">
                    @if(file_exists(public_path('images/logo.png')))
                        <img src="{{ asset('images/logo.png') }}" alt="BookShare Logo" class="h-8 w-auto mr-2">
                    @else
                        <img src="{{ asset('images/logo.svg') }}" alt="BookShare Logo" class="h-8 w-auto mr-2">
                    @endif
                    <span class="text-lg font-bold text-gray-900">BookShare</span>
                </a>
            </div>
